...
// Finally, once the user completes and submits the form we make a call to Stripe by passing in the credit card name and the credit card details (this is handled by the Stripe SDK). We call the this.props.stripe.createToken method and in return we get the token or an error back. 
// We simply pass this and the number of notes to be stored to the settings page via the this.props.onSubmit method. We will be setting this up shortly.
